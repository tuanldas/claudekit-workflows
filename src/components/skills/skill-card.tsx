...
export function SkillCard({ skill, locale }: Props) {
  ...
  return (
    <Link
      ...
      className="block rounded-[var(--radius-lg)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-accent-ring)] focus-visible:ring-offset-2 focus-visible:ring-offset-background"
    >
      <Card interactive className="p-4">
        <article>
          <div className="mb-2 flex items-start justify-between gap-2">
            <h3 className="font-mono text-h3 font-semibold tracking-tight text-foreground">
              {skill.name}
            </h3>
